...
class Logger {
  ...
  error(message, metadata = {}) { return this._log("ERROR", message, metadata); }
  warn(message, metadata = {}) { return this._log("WARN", message, metadata); }
  info(message, metadata = {}) { return this._log("INFO", message, metadata); }
